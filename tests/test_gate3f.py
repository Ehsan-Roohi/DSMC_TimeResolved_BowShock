...
class Gate3FStaticTest(unittest.TestCase):
    ...
    def test_dynamic_solver_scope(self) -> None:
        ...
        self.assertIn("Foam::label maximumOwnershipBalanceError", dsmc)
        self.assertIn("const Foam::label ownershipError", dsmc)
        self.assertNotIn("long long maximumOwnershipBalanceError", dsmc)
        self.assertNotIn("const long long ownershipError =", dsmc)
